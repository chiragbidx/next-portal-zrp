...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your Streamly account",
        description: "Start watching unlimited movies and shows for free.",
      };
    }
    ...
    return {
      ...
      description: "Experience streaming without limits—sign in to continue.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="max-w-md text-sm text-muted-foreground">
                Explore trending blockbusters, family favorites, and series—get started in seconds and enjoy a seamless viewing experience.
              </p>
            </div>
            ...
            <CardContent className="space-y-6">
              ...
              {mode === "signin" ? (
                ...
                <form className="space-y-4" action={signUpAction}>
                  ...
                  <Button type="submit" className="w-full" disabled={isPending}>
                    {isPending ? "Creating account..." : "Create your free account"}
                  </Button>
                </form>
              )}
